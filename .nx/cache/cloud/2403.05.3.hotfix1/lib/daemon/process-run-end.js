...
var import_crypto2, import_fs2, path, import_path3, axios2, tar, output4, FileStorage;
  ...
  "src/lib/core/file-storage/file-storage.ts"() {
    ...
    FileStorage = class {
      ...
      async store(hash, url, cacheDirectory) {
        ...
        if (process.env.NRWL_INTERNAL_TAR_DEBUG) {
          ...
          while (currAttempt <= maxAttempts && !tarSuccess) {
            ...
            (0, import_fs2.mkdirSync)(tmpPath, { recursive: true });
            try {
              const q = (0, import_fs2.createReadStream)(tgz).pipe(
                tar.x({
                  cwd: tmpPath
                })
              );
      ...
      async downloadFile(url, tgz, commitFilePath) {
        ...
        if ((0, import_fs2.existsSync)(tgz)) {
          let i = 0;
          while (i++ < 50) {
            if ((0, import_fs2.existsSync)(commitFilePath))
              return;
            await wait(500);
          }
        }
        if (this.encryption.hasEncryption()) {
          await new Promise((res) => {
            const f = resp.data.pipe((0, import_fs2.createWriteStream)(tgz));
            f.on("close", () => res(null));
          });
      ...
      createCommitFile(commitFilePath) {
        (0, import_fs2.writeFileSync)(commitFilePath, "true");
      }
      ...
      async createFile(hash, cacheDirectory) {
        const tgz = this.createFileName(hash, cacheDirectory);
        try {
          (0, import_fs2.unlinkSync)(path.join(cacheDirectory, hash, "source"));
        } catch (e) {
        }
        await tar.c(
          {
      ...
      async uploadFile(url, tgz) {
        ...
        const tarData = (0, import_fs2.readFileSync)(tgz);
...
var import_fs3, import_util, import_zlib, output5, CloudRunApi;
var init_cloud_run_api = __esm({
  "src/lib/core/runners/cloud-enabled/cloud-run.api.ts"() {
    ...
    CloudRunApi = class {
      ...
      nxCloudVersion() {
        try {
          const v = JSON.parse((0, import_fs3.readFileSync)(`package.json`).toString());
...
var import_crypto4, import_fs4, E2EEncryption;
  ...
  "src/lib/core/file-storage/e2e-encryption.ts"() {
    ...
    E2EEncryption = class {
      ...
      encryptFile(file) {
        ...
        const decryptedFileContents = (0, import_fs4.readFileSync)(file);
        const e = cipher.update(decryptedFileContents);
        const encryptedFileContents = Buffer.concat([iv, e, cipher.final()]);
        (0, import_fs4.writeFileSync)(file, encryptedFileContents);
      }
      decryptFile(file) {
        const encryptedFileContents = (0, import_fs4.readFileSync)(file);
        try {
          ...
          (0, import_fs4.writeFileSync)(file, decryptedFileContents);
        } catch (e) {
          throw new Error(
