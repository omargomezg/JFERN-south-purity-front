...
export class CommonClientService {
    ...
    getSaleOrder(user: string, pagination: PaginationModel): Observable<PageInterface<SaleOrderInterface>> {
        let queryParams = new HttpParams();
        ...
        return this.httpClient.get<PageInterface<SaleOrderInterface>>(`${environment.apiUrl}/sale-order`, {params: queryParams});
    }
